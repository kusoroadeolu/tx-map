...
compose multiple operations on transactional objects atomically — something unattainable with undisciplined use of
...
SizeLockers -> These are transactions which directly affect the size of the collection
