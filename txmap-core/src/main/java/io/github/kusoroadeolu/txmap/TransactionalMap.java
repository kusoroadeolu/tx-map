...
import io.github.kusoroadeolu.txmap.uncommitted.ReadUncommittedTransactionalMap;
...
public interface TransactionalMap<K, V> {
    ...
    static <K, V>TransactionalMap<K,  V> createReadUncommitted(){
        return new ReadUncommittedTransactionalMap<>();
    }
