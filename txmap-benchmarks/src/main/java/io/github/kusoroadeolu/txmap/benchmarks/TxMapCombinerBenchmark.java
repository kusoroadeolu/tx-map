...
//            case "array" -> TransactionalMap.createFlatCombined(CombinerType.ARRAY);
//            case "unbound" -> TransactionalMap.createFlatCombined(CombinerType.UNBOUND);
//            case "sem" -> TransactionalMap.createFlatCombined(CombinerType.SEMAPHORE);
